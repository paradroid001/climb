...
project = "GDWiiInput"
copyright = "2025-present Akshay Shankar and GDWiiInput contributors (CC by 3.0)"
author = "Akshay Shankar and GDWiiInput contributors"
...
ogp_site_name = "GDWiiInput documentation"
...
supported_languages = {
    "en": "GDWiiInput %s documentation in English",
}
...
html_context = {
    ...
    "github_user": "20akshay00",  # Username
    "github_repo": "GDWiiInput",  # Repo name
    "github_version": "main",  # Version
    "conf_py_path": "/docs/",  # Path in the checkout to the docs root
    "godot_inject_language_links": True,
    "godot_docs_supported_languages": list(supported_languages.keys()),
    "godot_docs_title": supported_languages[language],
    "godot_docs_basepath": "https://GDWiiInput.readthedocs.io/",
...
html_logo = "images/GDWiiInputDocs.svg"
...
htmlhelp_basename = "GDWiiInputdoc"
...
latex_documents = [
    (
        ...
        "Akshay Shankar and GDWiiInput contributors",
        "manual",
    ),
]
